  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="relative flex flex-col items-center gap-5">
        ...
        />
        <p className="absolute inset-0 flex flex-col items-start justify-center z-10 container text-center max-w-[700px] text-white font-bold italic text-[14px] sm:text-[24px]">
      ...
      <div className="flex flex-col gap-10 mt-[4rem]">
        <h2 className="text-center text-2xl font-semibold">Галерия</h2>
        <CateringSlider />
      </div>
          ...
          {standarts.map((standart, idx) => (
            <div className="flex items-start max-w-[700px] gap-10" key={idx}>
              <div className="flex flex-col items-center gap-5 text-center">
                ...
                />
                <p className="text-sm sm:text-base">{standart.text}</p>
              </div>
            </div>
          ))}
        </div>
